...
//Devuelve el elemento del subvector de la posicion 
    ...
    public static void main(String[] args) {
          VectorBitsG A=new VectorBitsG(10,30);//Con 30 bits como maximo
          
         // VectorBitsG A=new VectorBitsG(10,31);Muestra un valor no esperado
         //   VectorBitsG A=new VectorBitsG(10,32);Muestra un valor no esperado
         //por lo tanto no trabajar con 31 y 32 bits porque se genera un error 
         //en el metodo insertar de esta clase
         // A.insertar(-1140329953,1);
          A.insertar(15, 4);
          A.insertar(127, 10);
